                  ...
                  {isOpen && (
                    <div className="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                      ...
                      >
                        ...
                        >
                          <i className="fa-solid fa-user mr-2"></i>Edit Profile
                        </Link>
                        <Link
                          to="/my-applications"
                          className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                          ...
                          onClick={toggleDropdown}
                        >
                          <i className="fa-solid fa-file-contract mr-2"></i>My Applications
                        </Link>
                        <Link
                          to="/saved-jobs"
                          className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                          ...
                          onClick={toggleDropdown}
                        >
                          <i className="fa-solid fa-bookmark mr-2"></i>Saved Jobs
                        </Link>
                        <p
